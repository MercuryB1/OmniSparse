...
class SparseOPTAttention(nn.Module):
    ...
    def __init__(
        ...
        self.k_proj = SparseLinear(
            org_module.k_proj,
            sparsity_ratio=args.sparsity_ratio,
        )
        self.v_proj = SparseLinear(
            org_module.v_proj,
            sparsity_ratio=args.sparsity_ratio,
        )
        self.q_proj = SparseLinear(
            org_module.q_proj,
            sparsity_ratio=args.sparsity_ratio,
        )
        self.out_proj = SparseLinear(
            org_module.out_proj, sparsity_ratio=args.sparsity_ratio,
        )
    ...
    def set_quant_state(self, sparse: bool = False):
...
class SparseOPTDecoderLayer(nn.Module):
    def __init__(
        ...
        self.self_attn = SparseOPTAttention(
